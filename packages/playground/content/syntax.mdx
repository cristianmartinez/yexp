...
For exact semantics, the complete built-in registry, compatibility behavior, grammar, and port conformance rules, read the [Yexp language specification](https://github.com/cristianmartinez/yexp/blob/main/docs/spec.md).
