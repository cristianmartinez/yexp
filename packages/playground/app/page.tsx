          ...
          <div className="grid grid-cols-1 xl:grid-cols-[350px,1fr] gap-6">
            ...
            <Card className="h-fit sticky top-6">
              <CardHeader>
                ...
                <CardDescription>
                  Initial data available to all cells
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Write your Expr expression to evaluate
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  JSON data available to your expression
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Evaluated output from your expression
                </CardDescription>
              </CardHeader>
              <CardContent>
                {result.error ? (
